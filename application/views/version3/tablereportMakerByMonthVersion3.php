...
<script type="text/javascript">
					...
					hosController.updateSettings({
						afterSelectionEnd: function(r, c, r2, c2) {
							...
							if(c == 1){
								...
								getdataValue(is_report_Schedule,reportScheduleID);
							}
							if(c==0 && r!=6)
							{
	...
	function getdataValue(is_report_Schedule,reportScheduleID){
		$('#TableDiv').html('');
		if((reportScheduleID == "" || reportScheduleID == null || reportScheduleID == 0) && (is_report_Schedule == "" || is_report_Schedule == null || is_report_Schedule == 0)){
			...
			var html=getdatafromHashKey(is_report_Schedule,reportScheduleID);
			$('#newModal').modal('show');

		}
	}
	function getdatafromHashKey(is_report_Schedule,reportScheduleID) {
		$("#TransTabUl").hide();
